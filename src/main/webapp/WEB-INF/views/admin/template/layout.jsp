...
<%
    ...
    //
    if(ipAddress.equals("192.168.10.27")||ipAddress.equals("0:0:0:0:0:0:0:1")||ipAddress.equals("127.0.0.1")||ipAddress.equals("192.168.10.3")) {
%>
...
<body id="admin" class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">
