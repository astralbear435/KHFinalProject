...
<section class="content container-fluid">
	<form:form commandName="command" action="noticeModify.do"
		id="modify_form" enctype="multipart/form-data">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">
					<label for="n_subject">제목 </label>
					<form:input path="n_subject"></form:input>
					<form:errors path="n_subject" cssClass="error-color" />
				</h3>
			</div>
			<div class="box-body">
				<form:hidden path="n_idx" />  
