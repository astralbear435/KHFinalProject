			...
			<form:form commandName="command" action="sendEmail.do" id="register_form" enctype="multipart/form-data">
				<fieldset class="clearB">
					...
					<div class="form-group clearB">
						...
						<input type="text" name="m_name" id="m_name" class="form-control" placeholder="이름 입력">
					...
					<div class="form-group clearE">
						...
						<input type="password" name="checkPw" id="checkPw" class="form-control" placeholder="비밀번호확인 입력">
						<div id="message_checkPw"></div>
					</div>
					
					<div class="form-group clearF">
						<label for="m_phone">전화번호</label>
						<input type="text" name="m_phone" id="m_phone" class="form-control" placeholder="'-'을 제외한 숫자입력">
					...
					<div class="form-group clearB">
						...
						<input type="text" name="m_address" id="m_address" class="form-control" readonly>
					</div>
					
					<div class="form-group clearB">
						<label for="m_address_detail">상세주소</label>
						<input type="text" name="m_address_detail" id="m_address_detail" class="form-control">
					...
					<div class="w500 h72">
						<div class="form-group floatL">
							...
							<input type="email" name="m_email" id="m_email" style="width: 290px;" value="${command.m_email}" class="form-control" placeholder="test@test.com"/>
						</div>
					...
					<div class="form-group">
						...
						<input type="text" name="m_birth" id="m_birth" class="form-control" placeholder="19920816">
